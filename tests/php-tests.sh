...
# This script sets up the environment and runs PHP unit and integration tests for the project.
...
# Set up database for testing puropses with dummy data
...
# Apply patches needed for tests (if any are available)
